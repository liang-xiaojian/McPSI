...
namespace std {
template <>
class numeric_limits<mcpsi::uint256> {
 public:
  ...
  static constexpr mcpsi::uint256(min)() { return 0; }
  static constexpr mcpsi::uint256 lowest() { return 0; }
  static constexpr mcpsi::uint256(max)() { return mcpsi::Uint256Max(); }
  static constexpr mcpsi::uint256 epsilon() { return 0; }
  static constexpr mcpsi::uint256 round_error() { return 0; }
  static constexpr mcpsi::uint256 infinity() { return 0; }
  static constexpr mcpsi::uint256 quiet_NaN() { return 0; }
  static constexpr mcpsi::uint256 signaling_NaN() { return 0; }
  static constexpr mcpsi::uint256 denorm_min() { return 0; }
};
}  // namespace std

template <>
struct fmt::formatter<mcpsi::uint256> {
  constexpr auto parse(fmt::format_parse_context& ctx) { return ctx.begin(); }

  template <typename FormatContext>
  auto format(const mcpsi::uint256& number, FormatContext& ctx) {
